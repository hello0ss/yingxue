            ...
            $("#btnss").click(function(){
                ...
                goEasy.publish({
                    ...
                    onFailed: function (error) {
                        alert("消息发送失败，错误编码："+error.code+" 错误信息：请输入内容");
                    }
                });
            });
        });
...
<body>
<center>
    <div style="width: 500px;height: 609px;border: 3px #2aabd2 solid">
        <!--内容展示区域-->
        <div id="showss" style="width: 494px;height: 500px;border: 3px #a6e1ec solid"></div>
        <!--输入文本发送区域-->
        <div style="width: 494px;height: 99px;border: 3px #aed0ea solid">
            <!--输入框-->
            <textarea id="sendss" style="width: 400px;height: 88px;border: 3px #ccaadd solid"></textarea>
            <!--发送按钮-->
            <button id="btnss" style="width: 60px;height: 60px;background-color: #acdd4a">发送</button>
        </div>
    </div>
</center>
</body>
